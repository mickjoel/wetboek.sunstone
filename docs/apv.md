...
1. Deze Algemene Plaatselijke Verordening (verder aangeduid als APV) is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente, en de stad Primelistiq.
...
1. Aanvullend op de APV is er het Wetboek Primelistiq (WPRP), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in Primelistiq.
...
7. Wanneer je met meerdere mensen die op Primelistiq spelen in een voice call zit is streamen niet toegestaan en moet je gedeafened en gemute zijn.
...
3. Officiële kleding verstrekt vanuit Primelistiq bedoeld voor specifieke groeperingen mogen niet door andere gebruikt worden tenzij hier sterke roleplay aan verbonden is.
...
1. Onder "criminele organisaties" vallen alle officiële groepen gevestigd in Primelistiq.
...
6. Een voorwaarde voor het samenwerken tussen criminele organisaties is dat er geen volledige samenwerking tussen alle organisaties ontstaat en dat dit niet gebeurd tijdens het witwassen van geld. Dit is ter beoordeling van de Hoge Raad van Primelistiq.
7. Wanneer officiële organisaties een samenwerking aangaan met een andere officiële organisatie dan dient dit gemeld te worden volgens het juiste format in het daarvoor aangemaakte kanaal in de Primelistiq Discord.
...
---------------------
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad Primelistiq, opgetekend door Mick Joel Escobar, te Primelistiq.
