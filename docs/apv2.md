...
1. Aanvullend op de APV is er het Wetboek Sunstone (WSRP), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in Sunstone.
...
7. Wanneer je met meerdere mensen die op Sunstone spelen in een voice call zit is streamen niet toegestaan en moet je gedeafened en gemute zijn.
...
3. Officiële kleding verstrekt vanuit Sunstone bedoeld voor specifieke groeperingen mogen niet door andere gebruikt worden tenzij hier sterke roleplay aan verbonden is.
...
---------------------
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad Sunstone, opgetekend door Mick Joel Escobar, te Primelistiq.
